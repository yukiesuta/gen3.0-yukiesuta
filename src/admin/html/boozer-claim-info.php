                                    ...
                                    <td>
                                        <form method='POST' action='boozer-claim-info-edit-complete.php'>
                                            <select name="claim_status">
                                                ...
                                                <option value="1" <?php if ($agency->claim_status === 1) {
                                                                        echo "selected";
                                                                    } ?>>請求済み</option>
                                                <option value="2" <?php if ($agency->claim_status === 2) {
                                                                        echo "selected";
                                                                    } ?>>入金済み</option>
                                                <option value="3" <?php if ($agency->claim_status === 3) {
                                                                        echo "selected";
                                                                    } ?>>入金遅滞</option>
                                                <option value="4" <?php if ($agency->claim_status === 4) {
                                                                        echo "selected";
                                                                    } ?>>請求不能</option>
                                            </select>
